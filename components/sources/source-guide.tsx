    ...
    <div className="grid gap-6">
      ...
      <section className="grid gap-4 lg:grid-cols-2">
        <article className="rounded-[1.75rem] border border-[var(--line-strong)] bg-[var(--surface-1)] p-5 shadow-[0_18px_52px_rgba(0,0,0,0.16)]">
          ...
          <ul className="mt-4 grid gap-3 text-sm leading-7 text-[var(--ink-soft)]">
            ...
            <li>Film Forage never guesses service availability when TMDB does not provide it.</li>
          </ul>
        </article>
        <article className="rounded-[1.75rem] border border-[var(--line-strong)] bg-[var(--surface-1)] p-5 shadow-[0_18px_52px_rgba(0,0,0,0.16)]">
      ...
      <section className="rounded-[1.75rem] border border-[var(--line-strong)] bg-[var(--surface-1)] p-5 shadow-[0_18px_52px_rgba(0,0,0,0.16)]">
        ...
        <p className="mt-4 text-sm leading-7 text-[var(--ink-soft)]">
          This product uses the TMDB API but is not endorsed or certified by TMDB. Streaming availability comes from JustWatch data surfaced by TMDB. Use provider links as a starting point and verify availability in the target app before pressing play.
        </p>
      </section>
    </div>
  );
